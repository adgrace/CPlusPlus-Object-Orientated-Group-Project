...
class Circle : public Polygon {														// create Circle class inheriting from Polygon
	public:
		...
		void set_radius(const double new_radius) { radius = new_radius; };			// Setter: sets the radius of circle
		void set_segments(const int new_segments) { segments = new_segments; };		// Setter: sets the number of segments of circle
